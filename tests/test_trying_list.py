...
from proto_config import load_env_trying_list, get_env_values
...
def setup():
    ...
    folder_data, file_csv = load_env_trying_list(get_env_values(), fail)
...
def test_compute_time_tracking(setup):
